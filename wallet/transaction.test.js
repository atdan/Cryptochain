...
describe('Transaction', () => {
    ...
    beforeEach(() => {
        ...
        recipient = 'reciepient-public-key';
        amount = 50;
    ...
    describe('outputMap', () => {
        it('has an `outputMap`', () => {
            // console.log('outputMap:', transaction)
            expect(transaction).toHaveProperty('outputMap')
        })
        it('outputs the amount to the `reciepient`', () => {
    ...
    describe('update()', () => {
        ...
        describe('and the amount is valid', () => {
            ...
            it('outputs the amount to the next reciepient', () => {
            ...
            it('maintains a total output value that still matches output amount', () => {
